...
class Walker2dEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, a):
        ...
        reward_vx = 1.5 * (posafter - posbefore) / self.dt + alive_bonus
        reward_high = 12. * (height - self.init_qpos[1]) + alive_bonus
        ...
        return ob, 0., done, {'obj': np.array([reward_vx, reward_high, reward_energy])}
